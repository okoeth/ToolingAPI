...
/**
 * <p>Java class for ApexExecutionOverlayAction complex type.
 * 
 ...
 *         &lt;element name="ExecutableEntity" type="{urn:tooling.soap.sforce.com}Name" minOccurs="0"/>
...
@XmlType(name = "ApexExecutionOverlayAction", propOrder = {
    "actionScript",
    "actionScriptType",
    "createdBy",
    "createdById",
    ...
    extends SObject
{
    ...
    @XmlElementRef(name = "ExecutableEntity", namespace = "urn:tooling.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Name> executableEntity;
    @XmlElementRef(name = "ExecutableEntityId", namespace = "urn:tooling.soap.sforce.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> executableEntityId;
     ...
     *     
     */
    public JAXBElement<Name> getExecutableEntity() {
     ...
     *     
     */
    public void setExecutableEntity(JAXBElement<Name> value) {
        this.executableEntity = value;
    }
     ...
     *     
     */
    public JAXBElement<String> getExecutableEntityId() {
     ...
     *     
     */
    public void setExecutableEntityId(JAXBElement<String> value) {
        this.executableEntityId = value;
    }
